...
const mapState = (state: RootState): MapStateProps => ({
  ...
  elemPower: getElemPower(state),
  secondElemTypes: getSecondElemTypes(state),
  secondElemPower: getSecondElemPower(state),
  trainingTime: getTrainingTime(state),
  cooldownTime: getCooldownTime(state),
  breedAmount: getBreedAmount(state),
