export enum Section {
  ...
  ELEMENTAL_AFFINITIY = 'elemental_affinitiy',
  ELEMENT_TYPE = 'element_type',
  ELEMENT_POWER = 'element_power',
  SECOND_ELEMENT_TYPE = 'second_element_type',
  SECOND_ELEMENT_POWER = 'second_element_power',
  ELEMENT_GENES_TALENT = 'element_genes_talent',
  BATTLE_FIGHTING = 'battle_fighting',
  SPECIALTY = 'specialty',
  TRAINING_TIME = 'training_time',
  CARE_TRAINING = 'care_training',
  BREEDING = 'breeding',
  COOLDOWN_TIME = 'cooldown_time',
  BREED_AMOUNT = 'breed_amount',
