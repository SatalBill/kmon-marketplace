    ...
    yield put(
      fetchNFTsRequest({
        ...
        params: {
          ...
          elemPower: arrayToString(elemPower),
          secondElemTypes: arrayToString(secondElemTypes),
          secondElemPower: arrayToString(secondElemPower),
          trainingTime: arrayToString(trainingTime),
          cooldownTime: arrayToString(cooldownTime),
          breedAmount: arrayToString(breedAmount),
...
function* getNewSearchOptions(current: SearchOptions) {
  let previous: SearchOptions = {
    ...
    elemPower: yield select(getElemPower),
    secondElemTypes: yield select(getSecondElemTypes),
    secondElemPower: yield select(getSecondElemPower),
    trainingTime: yield select(getTrainingTime),
    cooldownTime: yield select(getCooldownTime),
    breedAmount: yield select(getBreedAmount),
